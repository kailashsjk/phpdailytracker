...
<body>
	<table width="80%" align="center" bgcolor="#D3D3D3">
		...
		<tr>
			<td>
				<form name="Admin_Login" action="login.cp.php" method="post"
					onSubmit="return val();">
					...
					<tr>
							...
							<td><input type="text" width="150px" required name="txtuserName" value="" /></td>
						</tr>
						<tr>
							<td height="35px" align="center">Password:</td>
							<td><input type="password" width="150px" name="txtpwd" required value="" /></td>
						</tr>
						<tr>
